...
const ProductCard = ({ product }: ProductCardProps) => {
    ...
    return (
        <div className='w-full max-w-[280px] max-h-[350px] bg-white rounded-sm shadow flex flex-col items-center justify-center group relative pt-6'>
            <div className='h-[200px] p-4 min-w-[120px] md:min-w-[145px] max-w-[200px]'>
                <Image width={150} height={200} src={product.productImage[0]} className='h-[150px] w-[150px] object-scale-down transition-all group-hover:scale-125' alt='productImg' />
            </div>
